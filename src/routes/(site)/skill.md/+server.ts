// skill.md — serves the agent skill's SKILL.md as text/markdown.
// MIRROR of skills/markdown-graphs/SKILL.md (the canonical file): keep the two
// in sync — the duplication is intentional so the route ships no file I/O.
...
Read recipes.md (https://markgraphy.vercel.app/skill/recipes.md) before
writing usage. Unsure which component? Fetch
https://markgraphy.vercel.app/llms.txt.
...
| -------------------- | ------------------------ | ------------------------------------ |
| \`--text-primary\`        | \`oklch(0.93 0 0)\`        | primary text                         |
